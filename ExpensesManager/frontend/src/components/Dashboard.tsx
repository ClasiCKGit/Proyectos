        ...
        <div className={styles.content}>
          ...
          <div className={styles.statsGrid}>
            <StatCard
              ...
              variant={
                stats.currentMonth.balance >= 0 ? "positive" : "negative"
              }
              icon="💳"
            />
            <StatCard
            ...
            <StatCard
              label="Gastos"
              value={formatCurrency(stats.currentMonth.totalExpenses)}
          ...
          {stats.budgetAlerts.length > 0 && (
            <div className={styles.card}>
              <p className={styles.cardTitle}>⚠️ Alertas de presupuesto</p>
          ...
          <div className={styles.card}>
            <div className={styles.cardHeader}>
              <p className={styles.cardTitle}>Últimos movimientos</p>
              <button
